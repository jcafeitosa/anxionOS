...
type: spec
status: superseded
superseded_by: brain/project-docs/specs/003-investment-lifecycle/spec.md
taskboard_issue: ANX-455
---

> **Legado / superseded (ANX-455).** A spec 003 canônica está em `brain/project-docs/specs/003-investment-lifecycle/spec.md` com **status accepted**. Esta cópia versionada **não prevalece** e **não** declara draft. Homologação de engines reais (ST08) permanece backlog. Registro: [docs/document-precedence.md](../../../docs/document-precedence.md).
