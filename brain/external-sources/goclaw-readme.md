---
title: nextlevelbuilder/goclaw — README preservado
description: README original preservado como referência de projeto.
type: source
...
tags:
  ...
  - text
cluster: anxionos
extraction_note: Conteúdo textual do README obtido pela API de contents do GitHub na branch padrão; preservado literalmente em bloco de código para não executar HTML nem reinterpretar links relativos. Imagens e arquivos vinculados não foram capturados. Revisão não fixada por commit.
---
