    ...
    "nodes": [
      {
        "any": [
          {
            ...
            "relatedNodes": [
              {
                "html": "<div class=\"hidden h-dvh w-[300px] shrink-0 flex-col border-r border-border bg-surface px-4 py-4 md:flex justify-between gap-10 overflow-hidden\" data-testid=\"console-sidebar\" data-console=\"owner\" style=\"width: 77.4831px;\">",
                "target": [
                  ".h-dvh"
                ]
              }
            ...
            "impact": "serious",
            "message": "Element has insufficient color contrast of 1.16 (foreground color: #1c1c1e, background color: #0a0a0c, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1"
          }
        ],
        "all": [],
        "none": [],
        ...
        "failureSummary": "Fix any of the following:\n  Element has insufficient color contrast of 1.16 (foreground color: #1c1c1e, background color: #0a0a0c, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1"
      },
      {
        "any": [
          {
