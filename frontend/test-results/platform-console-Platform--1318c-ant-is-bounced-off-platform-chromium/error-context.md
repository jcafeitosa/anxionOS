...
- Name: platform-console.spec.ts >> Platform console (ANX-166 G3) >> operator without grant is bounced off /platform
- Location: e2e/platform-console.spec.ts:74:2
...
Expected pattern: not /\/platform$/
Received string: "http://127.0.0.1:4321/platform"
Timeout: 5000ms

Call log:
  - Expect "not toHaveURL" with timeout 5000ms
    14 × locator resolved to <html lang="pt-BR">…</html>
       - unexpected value "http://127.0.0.1:4321/platform"
...
```ts
  ...
  3   | 
  4   | const PLATFORM_PRINCIPAL_ID = "aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa";
  5   | 
  6   | const authorizedPlatformPostLogin = {
  7   | 	authenticated: true,
  8   | 	emailVerified: true,
  9   | 	mfaRequired: false,
  10  | 	principal: {
  11  | 		id: PLATFORM_PRINCIPAL_ID,
  12  | 		authUserId: "auth-platform-g3",
  13  | 		email: "platform-g3@anxionos.local",
  14  | 		displayName: "Platform G3",
  15  | 	},
  16  | 	membershipsActive: [],
  17  | 	membershipsPending: [],
  18  | 	platformAccess: true,
  19  | 	partnerAccess: false,
  20  | 	onboardingState: {
  21  | 		needsProfile: false,
  22  | 		needsOrganization: false,
  23  | 	},
  24  | 	decision: {
  25  | 		kind: "platform" as const,
  26  | 		reason: "console.platform_grant",
  27  | 	},
  28  | };
  29  | 
