...
- Name: operator-console.spec.ts >> Operator console intervention panels (ANX-165 S9) >> kill switch confirm dialog keeps principal fields read-only when status is ready
- Location: e2e/operator-console.spec.ts:87:2
