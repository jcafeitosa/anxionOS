...
- Name: platform-console.spec.ts >> Platform console (ANX-166 G3) >> authorized PLATFORM session never calls agency operations and keeps recovery honest
- Location: e2e/platform-console.spec.ts:84:2
