...
WHERE referral_code ~* '(api[_-]?key|authorization|bearer|credential|password|private[_-]?key|secret|token)[[:space:]]*([:=]|[[:space:]])+[[:space:]]*[^[:space:],]+'
	...
	OR referral_code ~* '(^|[^A-Za-z0-9_])(sk|pk)_(live|test)_'
	OR referral_code ~* '(^|[^A-Za-z0-9_])gh[pousr]_'
	OR referral_code ~* '(^|[^A-Za-z0-9_])github_pat_'
	OR referral_code ~* '(^|[^A-Za-z0-9_])xox[baprs]-'
	OR referral_code ~* '(^|[^A-Za-z0-9_])AKIA[0-9A-Z]{16}'
...
WHERE display_name ~* '(api[_-]?key|authorization|bearer|credential|password|private[_-]?key|secret|token)[[:space:]]*([:=]|[[:space:]])+[[:space:]]*[^[:space:],]+'
	...
	OR display_name ~* '(^|[^A-Za-z0-9_])(sk|pk)_(live|test)_'
	OR display_name ~* '(^|[^A-Za-z0-9_])gh[pousr]_'
	OR display_name ~* '(^|[^A-Za-z0-9_])github_pat_'
	OR display_name ~* '(^|[^A-Za-z0-9_])xox[baprs]-'
	OR display_name ~* '(^|[^A-Za-z0-9_])AKIA[0-9A-Z]{16}'
...
WHERE approval_reference IS NOT NULL
	AND (
		...
		OR approval_reference ~* '(^|[^A-Za-z0-9_])(sk|pk)_(live|test)_'
		OR approval_reference ~* '(^|[^A-Za-z0-9_])gh[pousr]_'
		OR approval_reference ~* '(^|[^A-Za-z0-9_])github_pat_'
		OR approval_reference ~* '(^|[^A-Za-z0-9_])xox[baprs]-'
		OR approval_reference ~* '(^|[^A-Za-z0-9_])AKIA[0-9A-Z]{16}'
...
WHERE failure_reason IS NOT NULL
	AND (
		...
		OR failure_reason ~* '(^|[^A-Za-z0-9_])(sk|pk)_(live|test)_'
		OR failure_reason ~* '(^|[^A-Za-z0-9_])gh[pousr]_'
		OR failure_reason ~* '(^|[^A-Za-z0-9_])github_pat_'
		OR failure_reason ~* '(^|[^A-Za-z0-9_])xox[baprs]-'
		OR failure_reason ~* '(^|[^A-Za-z0-9_])AKIA[0-9A-Z]{16}'
...
WHERE provider_reference IS NOT NULL
	AND (
		...
		OR provider_reference ~* '(^|[^A-Za-z0-9_])(sk|pk)_(live|test)_'
		OR provider_reference ~* '(^|[^A-Za-z0-9_])gh[pousr]_'
		OR provider_reference ~* '(^|[^A-Za-z0-9_])github_pat_'
		OR provider_reference ~* '(^|[^A-Za-z0-9_])xox[baprs]-'
		OR provider_reference ~* '(^|[^A-Za-z0-9_])AKIA[0-9A-Z]{16}'
...
WHERE reversal_reference IS NOT NULL
	AND (
		...
		OR reversal_reference ~* '(^|[^A-Za-z0-9_])(sk|pk)_(live|test)_'
		OR reversal_reference ~* '(^|[^A-Za-z0-9_])gh[pousr]_'
		OR reversal_reference ~* '(^|[^A-Za-z0-9_])github_pat_'
		OR reversal_reference ~* '(^|[^A-Za-z0-9_])xox[baprs]-'
		OR reversal_reference ~* '(^|[^A-Za-z0-9_])AKIA[0-9A-Z]{16}'
