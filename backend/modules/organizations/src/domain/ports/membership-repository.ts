...
export interface MembershipRepository {
    ...
    findByAgencyAndPrincipal(agencyId: string, principalId: string): Promise<Membership | null>;
    findInvitedByAgencyAndEmail(agencyId: string, email: string): Promise<Membership | null>;
