import { type CreateIncidentCommand, type OperationsCommandResult } from "@anxionos/contracts/operations";
import type { CommandJournalRepository } from "../../domain/ports/command-journal";
import type { OperationsUnitOfWork } from "../../domain/ports/operations-unit-of-work";
import { randomUUID } from "node:crypto";
import { createIncidentCommandSchema, operationsCommandResultSchema } from "@anxionos/contracts/operations";
...
export async function createIncident(deps: CreateIncidentDeps, input: CreateIncidentCommand): Promise<OperationsCommandResult> {
