export type ProjectionInboxStatus =
	| "pending"
	| "processing"
	| "acked"
	| "quarantined";
...
export type ProjectionInboxClaimResult =
...
export interface ProjectionInbox {
	find(
		eventId: string,
		consumerName: string,
	): Promise<ProjectionInboxEntry | null>;
	tryClaim(
		input: ProjectionInboxClaimInput,
	): Promise<ProjectionInboxClaimResult>;
