...
import type { GraphQueryResult, ScopeContext } from "@anxionos/contracts/graph";
import {
...
export async function handleTraversalNeighbors(
	runtime,
	body,
	scope,
	requestId,
	...
	if (!paramsParsed.success) {
		throw new GraphHttpError(
			"TRAVERSAL_INPUT_INVALID",
			"Invalid neighbors traversal params",
	...
	const neighbors = rawNeighbors.filter((neighbor) =>
		isNodeReadable(scope, neighbor.targetNodeKey),
	);
