...
export const graphSchemaNodeTypes = pgTable(
...
export const graphSchemaEdgeTypes = pgTable(
...
export const graphTraversalCatalog = pgTable(
	"graph_traversal_catalog",
	{
		...
		cacheable: graphTraversalCacheableEnum("cacheable")
			.notNull()
			.default("never"),
	...
	(table) => [primaryKey({ columns: [table.traversalId, table.queryVersion] })],
);
export const graphProjectionInbox = pgTable(
...
export const graphProjectionGeneration = pgTable(
...
export const graphProjectionDlq = pgTable(
	"graph_projection_dlq",
	{
