import { type CreateStrategyVersionCommand, type StrategiesCommandResult } from "@anxionos/contracts/strategies";
import type { CommandJournalRepository } from "../../domain/ports/command-journal";
import type { StrategiesUnitOfWork } from "../../domain/ports/strategies-unit-of-work";
import { randomUUID } from "node:crypto";
import { createStrategyVersionCommandSchema, strategiesCommandResultSchema } from "@anxionos/contracts/strategies";
...
export async function createStrategyVersion(deps: CreateStrategyVersionDeps, input: CreateStrategyVersionCommand): Promise<StrategiesCommandResult> {
