...
import type { CommandJournalRecord, CommandJournalRepository } from "../../domain/ports/command-journal";
...
export function createDrizzleCommandJournalRepository(db: NodePgDatabase<{
