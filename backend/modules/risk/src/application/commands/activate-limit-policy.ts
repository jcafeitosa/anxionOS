import { type ActivateLimitPolicyCommand, type RiskCommandResult } from "@anxionos/contracts/risk";
import type { CommandJournalRepository } from "../../domain/ports/command-journal";
import type { RiskUnitOfWork } from "../../domain/ports/risk-unit-of-work";
import { randomUUID } from "node:crypto";
import { activateLimitPolicyCommandSchema, riskCommandResultSchema } from "@anxionos/contracts/risk";
...
export async function activateLimitPolicy(deps: ActivateLimitPolicyDeps, input: ActivateLimitPolicyCommand): Promise<RiskCommandResult> {
