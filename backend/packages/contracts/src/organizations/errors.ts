...
export function resolveOrganizationErrorStatus(
	code: OrganizationErrorCode,
): number {
	return ORGANIZATION_ERROR_STATUS_MAP[
		code as keyof typeof ORGANIZATION_ERROR_STATUS_MAP
	];
}

export type OrganizationErrorCode = (typeof ORGANIZATION_ERROR_CODES)[number];

export type OrganizationErrorDetails = z.infer<
	typeof organizationErrorDetailsSchema
>;
