import { z } from "zod";
import { agencyStatusSchema, marketScopeSchema, membershipRoleSchema, onboardingStepSchema, } from "./types";
...
export const organizationEventPayloadSchema = z.discriminatedUnion("eventType", [
    z.object({
...
export type OrganizationEventType = (typeof ORGANIZATION_EVENT_TYPES)[keyof typeof ORGANIZATION_EVENT_TYPES];

export type AgencyCreatedPayload = z.infer<typeof agencyCreatedPayloadSchema>;
export type AgencyMarketsUpdatedPayload = z.infer<typeof agencyMarketsUpdatedPayloadSchema>;
export type AgencyStatusChangedPayload = z.infer<typeof agencyStatusChangedPayloadSchema>;
export type MembershipInvitedPayload = z.infer<typeof membershipInvitedPayloadSchema>;
export type MembershipActivatedPayload = z.infer<typeof membershipActivatedPayloadSchema>;
