import { z } from "zod";
import { capitalAccountIdSchema, capitalExecutionModeSchema, capitalReservationKindSchema, decimalAmountSchema, } from "./types";
...
export type RegisterCapitalAccountCommand = z.infer<typeof registerCapitalAccountCommandSchema>;

export type ProposeAllocationCommand = z.infer<typeof proposeAllocationCommandSchema>;

export type ReserveForIntentCommand = z.infer<typeof reserveForIntentCommandSchema>;
