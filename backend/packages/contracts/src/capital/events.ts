import { z } from "zod";
import { capitalAccountIdSchema, capitalAllocationIdSchema, capitalReservationIdSchema, } from "./types";
...
export type CapitalEventType = (typeof CAPITAL_EVENT_TYPES)[keyof typeof CAPITAL_EVENT_TYPES];
