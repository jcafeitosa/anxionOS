...
export const partnersErrorCodeSchema = z.enum(Object.values(PARTNERS_ERROR_CODES) as [string, ...string[]]);
...
export type PartnersErrorCode = (typeof PARTNERS_ERROR_CODES)[keyof typeof PARTNERS_ERROR_CODES];
export function resolvePartnersErrorStatus(code: PartnersErrorCode): number {
    return PARTNERS_ERROR_STATUS_MAP[code as keyof typeof PARTNERS_ERROR_STATUS_MAP];
}
