import { z } from "zod";
import { decimalAmountSchema, partnersCommissionAccrualIdSchema, partnersPartnerIdSchema, partnersReferralIdSchema, } from "./types";
...
export type PartnersEventType = (typeof PARTNERS_EVENT_TYPES)[keyof typeof PARTNERS_EVENT_TYPES];
