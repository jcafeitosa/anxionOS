import { z } from "zod";
import { commissionRateSchema, partnersCommissionAccrualIdSchema, partnersPartnerIdSchema, partnersReferralIdSchema, } from "./types";
...
export type RegisterPartnerCommand = z.infer<typeof registerPartnerCommandSchema>;
