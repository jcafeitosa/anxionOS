import { z } from "zod";
import { decisionIdSchema, decisionsExecutionModeSchema, intentIdSchema, orderSideSchema, proposalIdSchema, proposalKindSchema, } from "./types";
...
export type DecisionsEventType = (typeof DECISIONS_EVENT_TYPES)[keyof typeof DECISIONS_EVENT_TYPES];
