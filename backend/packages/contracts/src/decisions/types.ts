...
export const proposalKindSchema = z.enum(["TRADE", "REBALANCE", "WITHDRAWAL", "HEDGE"]);
export const proposalStatusSchema = z.enum(["OPEN", "ACCEPTED", "SUPERSEDED", "REJECTED", "EXPIRED"]);
...
export type DecisionsExecutionMode = z.infer<typeof decisionsExecutionModeSchema>;
