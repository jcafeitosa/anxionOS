import { z } from "zod";
import { adapterGatewayEnvironmentSchema, adapterGatewayExecutionModeSchema, } from "./types";
...
export const adapterGatewayEventPayloadSchema = z.discriminatedUnion("eventType", [
    z.object({
...
export type AdapterGatewayEventType = (typeof ADAPTER_GATEWAY_EVENT_TYPES)[keyof typeof ADAPTER_GATEWAY_EVENT_TYPES];
