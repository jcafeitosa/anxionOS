import { z } from "zod";
import { assetClassSchema, orderSideSchema, orderTypeSchema } from "../decisions/types";
import { adapterActorTypeSchema, adapterCapabilityKeySchema, adapterDispatchIdSchema, adapterGatewayExecutionModeSchema, } from "./types";
...
export type AdapterGatewayCommandResult = z.infer<typeof adapterGatewayCommandResultSchema>;
/** Module command alias for dispatchAdapterCommand handler. */
