...
import { decimalScoreSchema, evaluationRecordIdSchema, evaluationScoreIdSchema, } from "./types";
...
export type EvaluationEventType = (typeof EVALUATION_EVENT_TYPES)[keyof typeof EVALUATION_EVENT_TYPES];
