...
export const performanceOutcomeRecordedBridgeSchema =
	outcomeRecordedPayloadSchema.pick({
		outcomeSnapshotId: true,
		organizationId: true,
		valueDate: true,
		linesSummary: true,
	});
export function mapOutcomeRecordedToEvaluationInput(
	outcome: PerformanceOutcomeRecordedBridge,
	commandId: string,
): RecordEvaluationScoreFromOutcomeInput {
...
export function computeOutcomeNotionalScore(
...
export type PerformanceOutcomeRecordedBridge = z.infer<
	typeof performanceOutcomeRecordedBridgeSchema
>;
