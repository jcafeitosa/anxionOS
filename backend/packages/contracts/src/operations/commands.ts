...
export type OperationsCommandResult = z.infer<typeof operationsCommandResultSchema>;

export type RegisterHealthCheckCommand = z.infer<typeof registerHealthCheckCommandSchema>;
