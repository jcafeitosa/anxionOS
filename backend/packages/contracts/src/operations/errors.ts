...
export const operationsErrorCodeSchema = z.enum(Object.values(OPERATIONS_ERROR_CODES) as [string, ...string[]]);
...
export type OperationsErrorCode = (typeof OPERATIONS_ERROR_CODES)[keyof typeof OPERATIONS_ERROR_CODES];
export function resolveOperationsErrorStatus(code: OperationsErrorCode): number {
    return OPERATIONS_ERROR_STATUS_MAP[code as keyof typeof OPERATIONS_ERROR_STATUS_MAP];
}
