...
export const simulationRunIdSchema = z
	.string()
	.regex(/^sim_run_[0-9a-f-]{36}$/i);
export const simulationBacktestRequestIdSchema = z
	.string()
...
export type SimulationBacktestRequestId = z.infer<
	typeof simulationBacktestRequestIdSchema
>;
export type SimulationRunStatus = z.infer<typeof simulationRunStatusSchema>;
export type SimulationExecutionMode = z.infer<
	typeof simulationExecutionModeSchema
>;
