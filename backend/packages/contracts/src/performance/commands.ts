...
export type PerformanceCommandResult = z.infer<typeof performanceCommandResultSchema>;

export type RecordOutcomeSnapshotCommand = z.infer<typeof recordOutcomeSnapshotCommandSchema>;
