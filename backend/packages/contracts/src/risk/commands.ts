import { z } from "zod";
import { decimalAmountSchema, riskCheckIdSchema, riskExecutionModeSchema, riskPermitIdSchema, riskPolicyIdSchema, checkResultSchema, } from "./types";
...
export type ActivateLimitPolicyCommand = z.infer<typeof activateLimitPolicyCommandSchema>;

export type RunPreTradeCheckCommand = z.infer<typeof runPreTradeCheckCommandSchema>;
