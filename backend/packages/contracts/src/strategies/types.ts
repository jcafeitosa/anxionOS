...
export const strategyVersionIdSchema = z.string().regex(/^st_ver_[0-9a-f-]{36}$/i);
...
const ALLOWED_VERSION_TRANSITIONS: Record<StrategyVersionLifecycle, readonly StrategyVersionLifecycle[]> = {
    DRAFT: ["BACKTESTED"],
...
export function assertValidStrategyVersionLifecycleTransition(from: StrategyVersionLifecycle, to: StrategyVersionLifecycle): void {
