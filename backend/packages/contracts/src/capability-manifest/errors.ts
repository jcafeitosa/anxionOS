...
export const capabilityManifestErrorCodeSchema = z.enum(CAPABILITY_MANIFEST_ERROR_CODES);
...
export type CapabilityManifestErrorCode = (typeof CAPABILITY_MANIFEST_ERROR_CODES)[number];
