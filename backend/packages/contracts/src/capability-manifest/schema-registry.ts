...
export function resolveCapabilitySchemaBundle(
	ref: CapabilitySchemaRef,
): CapabilitySchemaBundle {
	return {
...
export function getCapabilityInputSchema(
	ref: CapabilitySchemaRef,
): z.ZodTypeAny | undefined {
	return INPUT_SCHEMAS[ref];
}

export function getCapabilityOutputSchema(
	ref: CapabilitySchemaRef,
): z.ZodTypeAny | undefined {
	return OUTPUT_SCHEMAS[ref];
}

export function getCapabilityErrorSchema(
	ref: CapabilitySchemaRef,
): z.ZodTypeAny | undefined {
