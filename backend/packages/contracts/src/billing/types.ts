...
export const billingSubscriptionIdSchema = z.string().regex(/^bil_sub_[0-9a-f-]{36}$/i);
export const billingInvoiceIdSchema = z.string().regex(/^bil_inv_[0-9a-f-]{36}$/i);
export const billingInvoiceLineIdSchema = z.string().regex(/^bil_line_[0-9a-f-]{36}$/i);
export const billingUsageAggregationIdSchema = z.string().regex(/^bil_uag_[0-9a-f-]{36}$/i);
