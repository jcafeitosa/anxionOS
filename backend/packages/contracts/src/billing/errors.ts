...
export const billingErrorCodeSchema = z.enum(Object.values(BILLING_ERROR_CODES) as [string, ...string[]]);
...
export function resolveBillingErrorStatus(code: BillingErrorCode): number {
    return BILLING_ERROR_STATUS_MAP[code as keyof typeof BILLING_ERROR_STATUS_MAP];
}
