import { z } from "zod";
import { decimalAmountSchema, fillSideSchema, portfolioIdSchema, portfoliosExecutionModeSchema, positionIdSchema, holdingIdSchema, } from "./types";
...
export type PortfoliosCommandResult = z.infer<typeof portfoliosCommandResultSchema>;

export type CreatePortfolioCommand = z.infer<typeof createPortfolioCommandSchema>;

export type ApplyFillToPositionCommand = z.infer<typeof applyFillToPositionCommandSchema>;
