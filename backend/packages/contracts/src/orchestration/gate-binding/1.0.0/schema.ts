import { z } from "zod";
import { agentIdSchema, artifactDigestSchema, gateDispositionSchema, gateIdSchema, hierarchyModeSchema, issueIdentifierSchema, runIdSchema, } from "../../types";
...
export function refineGateBindingDigestRules(val: Pick<GateBindingV1Object, "disposition" | "artifactDigest" | "notApplicableReason">, ctx: z.RefinementCtx): void {
...
export const gateBindingV1Schema = gateBindingV1ObjectSchema.superRefine(refineGateBindingDigestRules);
