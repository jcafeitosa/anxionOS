...
export function resolveConnectionsErrorStatus(
	code: ConnectionsErrorCode,
): number {
	return CONNECTIONS_ERROR_STATUS_MAP[
		code as keyof typeof CONNECTIONS_ERROR_STATUS_MAP
	];
}

export type ConnectionsErrorDetails = z.infer<
	typeof connectionsErrorDetailsSchema
>;
