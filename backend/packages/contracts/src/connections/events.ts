...
export const CONNECTIONS_EVENT_TYPES = {
	...
	INFERENCE_WAITING_HUMAN: "connections.inference.waiting_human.v1",
};
...
export const inferenceWaitingHumanPayloadSchema = z.object({
	inferenceRequestId: inferenceRequestIdSchema,
	bindingId: connectionBindingIdSchema,
...
export const connectionsEventPayloadSchema = z.discriminatedUnion("eventType", [
	...
	z.object({
		eventType: z.literal(CONNECTIONS_EVENT_TYPES.INFERENCE_WAITING_HUMAN),
		payload: inferenceWaitingHumanPayloadSchema,
	}),
]);

export type ConnectionsEventType =
	(typeof CONNECTIONS_EVENT_TYPES)[keyof typeof CONNECTIONS_EVENT_TYPES];
