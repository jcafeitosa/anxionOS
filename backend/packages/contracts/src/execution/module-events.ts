import { z } from "zod";
import { executionDecimalAmountSchema, executionModuleModeSchema, executionOrderSideSchema, } from "./module-types";
...
export const executionModuleEventPayloadSchema = z.discriminatedUnion("eventType", [
    z.object({
...
export type ExecutionModuleEventType = (typeof EXECUTION_MODULE_EVENT_TYPES)[keyof typeof EXECUTION_MODULE_EVENT_TYPES];
