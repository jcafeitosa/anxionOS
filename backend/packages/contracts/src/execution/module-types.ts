...
export const executionSessionIdSchema = z
	.string()
	.regex(/^ex_ses_[0-9a-f-]{36}$/i);
export const executionOrderIdSchema = z
	.string()
	.regex(/^ex_ord_[0-9a-f-]{36}$/i);
export const executionFillIdSchema = z
	.string()
	.regex(/^ex_fill_[0-9a-f-]{36}$/i);
export const venueAdapterRefIdSchema = z
	.string()
	.regex(/^ex_vad_[0-9a-f-]{36}$/i);
