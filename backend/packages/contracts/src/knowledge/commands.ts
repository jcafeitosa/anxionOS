import { z } from "zod";
import { aclRefSchema, blobRefSchema, dataClassificationSchema, documentIdSchema, embeddingSpaceIdSchema, indexGenerationIdSchema, knowledgeSourceIdSchema, knowledgeSourceKindSchema, } from "./types";
...
export type KnowledgeCommandResult = z.infer<typeof knowledgeCommandResultSchema>;

export type RegisterKnowledgeSourceCommand = z.infer<typeof registerKnowledgeSourceCommandSchema>;
