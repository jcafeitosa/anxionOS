...
export const domainEventEnvelopeV02Schema = institutionalEnvelopeCoreV02Schema.extend({
    ownerDomain: z.string().min(1),
    idempotencyKey: z.string().uuid().optional(),
});
export const domainCommandEnvelopeV02Schema = institutionalEnvelopeCoreV02Schema.extend({
    ownerDomain: z.string().min(1),
    idempotencyKey: z.string().uuid(),
});
export function parseDomainEventEnvelopeV02(input: unknown): DomainEventEnvelopeV02 {
    return domainEventEnvelopeV02Schema.parse(input);
}
export function parseDomainCommandEnvelopeV02(input: unknown): DomainCommandEnvelopeV02 {
...
export type DomainEventEnvelopeV02 = z.infer<typeof domainEventEnvelopeV02Schema>;

export type DomainCommandEnvelopeV02 = z.infer<typeof domainCommandEnvelopeV02Schema>;
