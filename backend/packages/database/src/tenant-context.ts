...
export function requireTenantContext(ctx: TenantContext | undefined): TenantContext {
	if (!ctx) {
		throw new TenantContextError("tenant context is required for authoritative queries");
	}
