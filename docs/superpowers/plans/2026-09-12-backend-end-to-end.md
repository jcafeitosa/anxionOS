...
- [x] `ANX-514`: agents no longer export an in-memory orchestration run fence; the fixture is isolated under tests and the domain port documents composition-root injection of orchestration-owned authority; agents/openbot verification passes 108/108.
