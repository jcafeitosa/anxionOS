...
- [x] `ANX-513`: knowledge memory lifecycle now uses a tenant-scoped PostgreSQL `knowledge_memories` store with natural-key deduplication, candidate→promoted persistence, transaction-bound promotion, and fixture isolation; regular suite passes 1851/1851 and fresh PostgreSQL oracle passes 1889/1889.
